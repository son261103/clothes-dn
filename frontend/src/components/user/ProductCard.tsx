...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  ...
  return (
    <motion.div 
      className="group relative bg-white dark:bg-white/5 rounded-3xl overflow-hidden border border-border hover:shadow-2xl hover:shadow-brand-orange/10 transition-all duration-500"
      whileHover={{ y: -5 }}
    >
      {/* Image Container */}
