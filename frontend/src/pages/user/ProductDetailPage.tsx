    ...
    <div className="min-h-screen pt-32 pb-20">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-20">
          ...
          {/* RIGHT: PRODUCT INFO */}
          <div className="lg:w-1/2">
            <div className="glass p-8 md:p-10 rounded-[2.5rem] bg-bg-sub/60 backdrop-blur-xl border border-border">
                ...
                <div className="flex gap-3">
                  {product.colors.map((color) => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full border-2 flex items-center justify-center transition-all ${selectedColor === color.name ? 'border-brand-orange scale-110 shadow-lg' : 'border-transparent hover:scale-105'
                        }`}
                ...
                <div className="flex flex-wrap gap-3">
                  {product.sizes.map((size) => (
                    <button
                      ...
                      className={`w-12 h-12 rounded-xl font-bold flex items-center justify-center transition-all border ${selectedSize === size
                        ? 'bg-brand-orange text-white border-brand-orange shadow-lg shadow-brand-orange/30'
                        : 'bg-bg-sub/50 border border-border text-text-main hover:border-brand-orange hover:text-brand-orange'
                        }`}
                    >
                      {size}
                    </button>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <div className="flex items-center bg-bg-sub/50 rounded-xl border border-border h-14 w-fit">
                  <button
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass p-8 rounded-3xl bg-bg-sub/40 backdrop-blur-md border border-border">
