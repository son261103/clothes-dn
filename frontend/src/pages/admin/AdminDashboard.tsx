    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-3xl font-bold mt-2">$24,567</p>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">$123.50</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">#ORD-003</td>
                  <td className="px-6 py-4 whitespace-nowrap">Robert Johnson</td>
                  <td className="px-6 py-4 whitespace-nowrap">2023-05-17</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                      Delivered
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">$321.75</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="flex items-center">
                ...
                <div className="ml-4 flex-1">
                  ...
                  <p className="text-gray-600 text-sm">Category: Clothing</p>
                </div>
                <div className="text-right">
                  <p className="font-medium">124 sales</p>
